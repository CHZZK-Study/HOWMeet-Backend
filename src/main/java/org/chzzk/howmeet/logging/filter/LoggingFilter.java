//package org.chzzk.howmeet.logging.filter;
//
...
//
//    public LoggingFilter(final StopWatch stopWatch, final ApiQueryCounter apiQueryCounter) {
...
//                    requestURIWithParams, queryCount, stopWatch.getLastTaskTimeMillis());
//            return;
//        }
//        log.info(RESPONSE_LOG_FORMAT, response.getStatus(), request.getMethod(), requestURIWithParams,
//                queryCount, stopWatch.getLastTaskTimeMillis(), jsonResponseBody.get());
//    }
//
